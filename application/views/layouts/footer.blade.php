        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span5 text-right">
                    ...
                    <a href="http://www.booj.com/blog" target="_blank"><i class="bicon-blog"></i></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span6 margin-bottom-30 clearfix">
                    ...
                    <h3>booj</h3>
                    <address>575 Union Boulevard, Suite 310<br>Lakewood, Colorado 80228</address>
                    <p>855-563-1925<br>info@booj.com</p>
                </div>
            </div>
        </div>
    </div>
</footer>
<script>(function(d, s, id) {var js, fjs = d.getElementsByTagName(s)[0];if (d.getElementById(id)) return;js = d.createElement(s); js.id = id;js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=219575128103821";fjs.parentNode.insertBefore(js, fjs);}(document, 'script', 'facebook-jssdk'));</script>