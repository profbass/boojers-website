...
<div class="row-fluid">
    ...
    <div class="span9">
    	...
    	<hr>
		<?php echo Form::open_for_files($controller_alias . '/update/' . $user->id, null, array('class' => 'form-horizontal') ); ?>
			<fieldset>	
				...
				<div class="control-group{{ isset($errors) && $errors->has('email') ? ' error' : '' }}">
					<div class="control-group">
						...
						<div class="controls">
							<?php
								echo Form::text('email', Input::old('email') ? Input::old('email') : $user->email, array('class' => 'span6', 'required' => 'required', 'placeholder' => 'Enter Email'));
							?>
                ...
                <div class="control-group">
                	<label class="control-label">Current Professional Photo</label>
                	<div class="controls">
                        <? if (!empty($user->professional_photo)): ?>
                            <a href="<?=$user->professional_photo;?>" target="_blank"><img src="<?=$user->professional_photo_small;?>" class="img-polaroid" alt="Avatar" style="max-width:100px;"></a>
                        <? else: ?>
                            No Image Uploaded
                        <? endif; ?>
                ...
                <div class="control-group">
                    <label class="control-label">Current Fun Photo</label>
                    <div class="controls">
                        <? if (!empty($user->fun_photo)): ?>
                            <a href="<?=$user->fun_photo;?>" target="_blank"><img src="<?=$user->fun_photo_small;?>" class="img-polaroid" alt="Avatar" style="max-width:100px;"></a>
                        <? else: ?>
                            No Image Uploaded
                        <? endif; ?>
                        <span class="help-inline">Image will be cropped to {{ $dims['width'] }} X {{ $dims['height'] }}</span>
